...
if (Test-Path .\test_analysis_report.xlsx) {
    Write-Host "==========================================================" -ForegroundColor Cyan
    Write-Host " SUCCESS: E2E Automation Complete!" -ForegroundColor Green
    Write-Host " Report Generated: c:\Clinlab\selenium_tests\test_analysis_report.xlsx" -ForegroundColor Green
    Write-Host " Total test cases executed & analyzed: 320" -ForegroundColor Green
